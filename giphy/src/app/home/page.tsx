    ...
    <>
        ...
        <div>
          ...
          <div className='flex'>
              ...
              <button className='bg-white rounded-r-md'>
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQgDiX-ebcfOPVym3qEoBOXUzj5IYxq5OjeBA&usqp=CAU" className='w-10 h-30 p-2 rounded-r-md' alt="Na" />
              </button>
          </div>
     ...
     <div>
      <div className='mt-10'>
        ...
        {gifs.map((gif) => (
          <div key={gif.id} className="gif-card m-2 w-[200px]   bg-gray-700 hover:bg-sky-700">
